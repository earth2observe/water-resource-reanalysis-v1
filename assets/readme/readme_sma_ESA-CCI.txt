Dataset name:
European Space Agency Climate Change Initiative Surface Soil Moisture SWI Combined Product (ESA-CCI)

Varialbe name: 
SWI (Volumetric Soil Water Index T-Value=5)
...
Downloaded site:
ftp://wci.earth2observe.eu/data/primary/public/tuwien/ESACCI-SOILMOISTURE-L3S-SWIV-COMBINED-v02.2
(data also available at http://www.esa-soilmoisture-cci.org/)
...
Name and Version of original source:
    CCI SM v02.2
